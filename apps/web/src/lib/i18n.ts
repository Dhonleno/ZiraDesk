...
void i18n
  ...
  .init({
    resources: {
      'pt-BR': { common: ptBRCommon, auth: ptBRAuth, admin: ptBRAdmin, crm: ptBRCrm, tickets: ptBRTickets, omnichannel: ptBROmnichannel, portal: ptBRPortal },
      'en-US': { common: enUSCommon, auth: enUSAuth, admin: enUSAdmin, crm: enUSCrm, tickets: enUSTickets, omnichannel: enUSOmnichannel, portal: enUSPortal },
      es: { common: esCommon, auth: esAuth, admin: esAdmin, crm: esCrm, tickets: esTickets, omnichannel: esOmnichannel, portal: esPortal },
    },
    fallbackLng: 'pt-BR',
    defaultNS: 'common',
