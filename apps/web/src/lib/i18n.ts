...
import enUSCampaigns from '../locales/en-US/campaigns.json';
...
void i18n
  ...
  .init({
    resources: {
      'pt-BR': { common: ptBRCommon, auth: ptBRAuth, admin: ptBRAdmin, crm: ptBRCrm, tickets: ptBRTickets, omnichannel: ptBROmnichannel, portal: ptBRPortal, legal: ptBRLegal, campaigns: ptBRCampaigns },
      'en-US': { common: enUSCommon, auth: enUSAuth, admin: enUSAdmin, crm: enUSCrm, tickets: enUSTickets, omnichannel: enUSOmnichannel, portal: enUSPortal, legal: enUSLegal, campaigns: enUSCampaigns },
      es: { common: esCommon, auth: esAuth, admin: esAdmin, crm: esCrm, tickets: esTickets, omnichannel: esOmnichannel, portal: esPortal, legal: esLegal, campaigns: esCampaigns },
    },
    fallbackLng: 'pt-BR',
    defaultNS: 'common',
